...
#define MIRROR_IMAGE_DFT MIRROR_VERTICAL
/**
 * Image attributes
 **/
...
void Paint_DrawLine(int16_t Xstart, int16_t Ystart, int16_t Xend, int16_t Yend, UWORD Color, DOT_PIXEL Line_width, LINE_STYLE Line_Style);
